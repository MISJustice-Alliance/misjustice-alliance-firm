...
- [[casey-case-investigator]] — Casey (Case Investigator)
- [[chronology-timeline-agent]] — Chronology (Timeline Agent)
- [[citation-auditor]] — Citation (Citation Auditor)
- [[iris-document-analyst]] — Iris (Document Analyst)
- [[lex-lead-counsel]] — Lex (Lead Counsel)
- [[mira-legal-researcher]] — Mira (Legal Researcher)
- [[ollie-paralegal]] — Ollie (Paralegal)
- [[quill-brief-writer]] — Quill (Brief Writer)
- [[rae-rights-advocate]] — Rae (Rights Advocate)
- [[social-media-manager]] — Social Media Manager (Public Advocate)
- [[sol-systems-liaison]] — Sol (Systems Liaison)
- [[webmaster]] — Webmaster (Site Manager)
...
- [[zero-human-company]] — Zero-Human Company (ZHC)
